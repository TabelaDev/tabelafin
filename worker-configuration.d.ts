/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example` (hash: c3f42520a0bde18ea280bca471b4e5f1)
// Runtime types generated with workerd@1.20260825.1 2026-08-01 nodejs_compat
interface __BaseEnv_Env {
	SESSIONS: KVNamespace;
	DB: D1Database;
	ASSETS: Fetcher;
	ORIGIN: "https://tabelafin-staging.ianptkcs-023.workers.dev" | "https://tabelafin.ianptkcs-023.workers.dev";
	VAPID_PUBLIC_KEY: "BNGg4bHjsBjz2tVbuoyGXAaBMmbaUbKgYizkf82DAYVO3hBWm7nNSghb6qx0hDYjn-N_lHN6RHaqSeoRkc5ZtH8" | "BLRtiZgDBYkAVW92C0WIfRmlehgF0g4vI7i6xC8VKYHziKVdcyxv3jtj0BIoin5LU255BX4pknqJENcPfswYAns";
	VAPID_SUBJECT: "https://tabelafin-staging.ianptkcs-023.workers.dev" | "https://tabelafin.ianptkcs-023.workers.dev";
	EMAIL_FROM: "ianptkcs@gmail.com";
	MASTER_KEY: string;
	VAPID_PRIVATE_KEY: string;
	BETTER_AUTH_SECRET: string;
	BETTER_AUTH_URL: string;
	PUBLIC_TABELAUTH_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ORIGIN" | "VAPID_PUBLIC_KEY" | "VAPID_SUBJECT" | "EMAIL_FROM" | "MASTER_KEY" | "VAPID_PRIVATE_KEY" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "PUBLIC_TABELAUTH_URL" | "PUBLIC_APP_URL" | "BREVO_API_KEY" | "DEEPSEEK_API_KEY">> {}
}
